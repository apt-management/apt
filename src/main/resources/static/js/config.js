// 로봇 IP 주소
const ROBOT_IP = '192.168.137.201';  // 순찰 차량의 IP 주소
const ROBOT_IP_02 = '192.168.137.153';  // 택배 차량의 IP 주소

// WebSocket 연결 URL
const ROSCAR_WS_URL = `ws://${ROBOT_IP}:9090`;  // WebSocket 연결 주소 (9090 포트)
const ROSCAR_WS_URL_02 = `ws://${ROBOT_IP_02}:9090`;  // WebSocket 연결 주소 (9090 포트)
...
window.ROBOT_IP_02 = ROBOT_IP_02;
window.ROSCAR_WS_URL = ROSCAR_WS_URL;
window.ROSCAR_WS_URL_02 = ROSCAR_WS_URL_02;
